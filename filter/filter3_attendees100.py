...
with open("D:/7.reseach/filter2/atendees2_filter.csv","r",encoding = "iso-8859-1") as file:
...
list_venue = []
set_eid_venue = set()
with open("D:/7.reseach/filter2/venue_filter2.csv","r",encoding = "iso-8859-1") as file:
    csv_reader = csv.reader(file)
    for row in csv_reader:
...
list_des = []
set_eid_des = set()
with open("D:/7.reseach/filter2/description_filter2.csv","r",encoding = "iso-8859-1") as file:
    csv_reader = csv.reader(file)
    for row in csv_reader:
...
list_info = []
set_eid_info = set()
with open("D:/7.reseach/filter2/infomation_filter2.csv","r",encoding = "iso-8859-1") as file:
    csv_reader = csv.reader(file)
    for row in csv_reader:
...
#export file att
with open("D:/7.reseach/filter3_drop-greater_100_attendees/attendees_filter3.csv", "w", encoding = "iso-8859-1", newline="")as file:
    writer = csv.writer(file)
    writer.writerows(list_attendees1)            
            
#export file venue
with open("D:/7.reseach/filter3_drop-greater_100_attendees/venue_filter3.csv", "w", encoding = "iso-8859-1", newline="")as file:
    writer = csv.writer(file)
    writer.writerows(list_venue1)            
            
#export file des
with open("D:/7.reseach/filter3_drop-greater_100_attendees/description_filter3.csv", "w", encoding = "iso-8859-1", newline="")as file:
    writer = csv.writer(file)
    writer.writerows(list_des)
            
#export file info
with open("D:/7.reseach/filter3_drop-greater_100_attendees/infomation_filter3.csv", "w", encoding = "iso-8859-1", newline="")as file:
    writer = csv.writer(file)
